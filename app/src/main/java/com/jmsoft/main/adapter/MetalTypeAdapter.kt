...
class MetalTypeAdapter(
    ...
    @SuppressLint("NotifyDataSetChanged")
    private fun showMetalDialog(position: Int) {
        ...
        dialogBinding.mcvSave.setOnClickListener {
            ...
            if (resultReturn?.aBoolean == true) {
                ...
                dialog.dismiss()
                metalTypeList[position] = dialogBinding.etMetalType.text.toString().trim()
